...
def get_user_examples_by_word_status_secure(
    ...
    try:
        ...
        logger.warning(f"User {user_id} attempted to access examples for word_status {user_word_status_id}")
        raise
    except Exception as e:
...
def create_user_definition_secure(
    ...
    try:
        ...
        logger.warning(f"User {user_id} attempted to create definition for word_status {user_word_status_id}")
        raise
    except Exception as e:
...
def get_definitions_for_word_status_secure(
    ...
    try:
        ...
        logger.warning(f"User {user_id} attempted to access definitions for word_status {user_word_status_id}")
        raise
    except Exception as e:
...
def create_user_synonym_secure(
    ...
    try:
        ...
        logger.warning(f"User {user_id} attempted to create synonym for word_status {user_word_status_id}")
        raise
    except Exception as e:
...
def list_user_synonyms_by_word_status_secure(
    ...
    try:
        ...
        logger.warning(f"User {user_id} attempted to access synonyms for word_status {user_word_status_id}")
        raise
    except Exception as e:
...
def create_user_tag_secure(
    ...
    try:
        ...
        return user_tags.create_user_tag(
            db=db,
            user_word_status_id=user_word_status_id,
            tag=tag
        )
        ...
        logger.warning(f"User {user_id} attempted to create tag for word_status {user_word_status_id}")
        raise
    except Exception as e:
...
def list_user_tags_by_word_status_secure(
    ...
    try:
        ...
        logger.warning(f"User {user_id} attempted to access tags for word_status {user_word_status_id}")
        raise
    except Exception as e:
...
def create_user_translation_secure(
    ...
    try:
        ...
        logger.warning(f"User {user_id} attempted to create translation for word_status {user_word_status_id}")
        raise
    except Exception as e:
...
def list_user_translations_by_word_status_secure(
    ...
    try:
        ...
        logger.warning(f"User {user_id} attempted to access translations for word_status {user_word_status_id}")
        raise
    except Exception as e:
