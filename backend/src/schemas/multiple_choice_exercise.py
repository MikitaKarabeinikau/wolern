...
class MultipleChoiceExerciseBase(BaseModel):
    ...
    options: List[str] = Field(..., min_length=2, max_length=10, example=["option1", "option2", "option3", "option4"])
    correct_answer: int = Field(..., ge=0, example=2)
...
class MultipleChoiceExerciseUpdate(BaseModel):
    ...
    options: Optional[List[str]] = Field(None, min_length=2, max_length=10, example=["option1", "option2", "option3", "option4"])
    correct_answer: Optional[int] = Field(None, ge=0, example=2)
