...
class UserTranslationBase(BaseModel):
    ...
    language: str = Field(
        ..., min_length=2, max_length=50, json_schema_extra={"example": "english"}
    )
    translation: str = Field(
        ..., min_length=1, max_length=200, json_schema_extra={"example": "cat"}
    )
...
class UserTranslationUpdate(BaseModel):
    ...
    language: Optional[str] = Field(
        None, min_length=2, max_length=50, json_schema_extra={"example": "french"}
    )
    translation: Optional[str] = Field(
        None, min_length=1, max_length=200, json_schema_extra={"example": "chat"}
    )
