...
def generate_vocabulary_exercise(target_word: str, difficulty: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if all(field in exercise_data["exercise"] for field in required_fields_exercise) and all(
            field in exercise_data["multiple_choice"] for field in required_fields_mc
        ):
