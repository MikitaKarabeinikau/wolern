...
from backend.src.database.models import Words, Definitions
from backend.src.database.crud.definitions import create_definition, get_definitions_by_word_id, get_definition_by_id
...
def test_create_definition(db_session):
    ...
    # Create a definition
    definition = create_definition(db_session, word_id=word.id, part_of_speech="noun", definition="A representative form or pattern.")
...
def test_get_definitions_by_word_id(db_session):
    ...
    create_definition(db_session, word_id=word.id, part_of_speech="noun", definition="A representative form or pattern.")
    create_definition(db_session, word_id=word.id, part_of_speech="verb", definition="To illustrate or demonstrate.")
