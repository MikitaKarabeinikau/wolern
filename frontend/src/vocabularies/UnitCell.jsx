...
function UnitCell({item, onUpdate, onDelete}) {
        ...
        return (
            <div className="unit-cell editing">
                ...
                <div className="unit-cell-actions">
                    <button onClick={handleUpdate} className='unit-cell-btn save'>Save</button>
                    <button onClick={cancelEditing} className='unit-cell-btn cancel'>Cancel</button>
                </div>
            </div>
        );
    }
